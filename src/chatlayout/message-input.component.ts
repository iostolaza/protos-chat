...
@Component({
  ...
  imports: [FormsModule],
  template: `
    <div class="p-4 border-t border-border flex gap-2 bg-background">
      <input type="text" placeholder="Type a message..." class="flex-1 p-2 border border-border rounded bg-card text-foreground placeholder:text-muted-foreground" />
      <button class="bg-primary text-primary-foreground p-2 rounded">Send</button>
